...
#loading data
train_data = pd.read_csv("titanic_assignment/train.csv")
...
if st.sidebar.checkbox("Display Original Data", False):
    original_data()

if st.sidebar.checkbox("Display Confusion Matrix", False):
    cm()

if st.sidebar.checkbox("Sex_vs_Survived", False):
    sex_survived()
